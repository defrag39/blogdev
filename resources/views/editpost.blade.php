      ...
      <div class="col-xs-3 col-sm-3 col-md-3">
        ...
        <div class="col-xs-9 col-sm-9 col-md-9">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" enctype="multipart/form-data" action="/wblog/editpost/{{$getpost->title_coll}}" method="POST">
                     {{ csrf_field() }}

                     <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                       <div class="col-xs-8 col-sm-8 col-md-8">
                             <label for="title" class="control-label">Judul Post</label>
                             <input type="text" name="title" class="form-control" value="{{$getpost->title}}" placeholder="Judul Posting" />
                             @if ($errors->has('title'))
                           ...
                           <div class="col-xs-4 col-sm-4 col-md-4">
                                   ...
                                   <select class="form-control" name="kategori">
                                     ...
                                     <option value="{{$cat->idcategory}}" @if($getpost->idcategory == $cat->idcategory) selected @endif>{{$cat->categoryname}}</option>
                                     @endforeach
                                     @else
                      ...
                      <div class="col-md-12">
                      <textarea id="konten" class="form-control" name="postbody" rows="12" cols="50">{{$getpost->postbody}}</textarea>
